...
class TimesUpHapticsService {
    static let shared = TimesUpHapticsService()
    ...
    func playPerkActivation() {
        ...
        do {
            ...
            let _ = CHHapticEventParameter(parameterID: .hapticIntensity, value: 1.0)
            let sharpnessStart = CHHapticEventParameter(parameterID: .hapticSharpness, value: 0.4)
            let _ = CHHapticEventParameter(parameterID: .hapticSharpness, value: 0.9)
