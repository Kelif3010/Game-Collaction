...
class GameManager: ObservableObject {
    ...
    let wordTranslationManager = WordTranslationManager()
    ...
    var availableCategories: [TimesUpCategory] { categoryManager.categories }
    ...
    private func handleMissedTerm(reason: MissReason) {
        ...
        if reason == .skip { TimesUpHapticsManager.shared.playSkip() }
