    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $showingAIGenerator) {
                AICategoryGeneratorView(categoryViewModel: categoryViewModel)
            }
            .sheet(item: $selectedCategory) { category in
                CategoryDetailView(category: category, categoryViewModel: categoryViewModel)
            }
...
#Preview {
    CategoryManagementView(categoryViewModel: TimesUpCategoryViewModel())
}
