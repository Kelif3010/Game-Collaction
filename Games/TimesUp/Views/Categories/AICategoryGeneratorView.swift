...
struct AICategoryGeneratorView: View {
                        ...
                        VStack(spacing: 24) {
                            ...
                            Button(action: generateCategories) {
                                HStack {
                                    ...
                                    Text(categoryViewModel.isGeneratingAI ? String(localized: "Generiere...") : String(localized: "Generieren"))
                                        .font(.title3.bold())
                                }
                                .foregroundStyle(.white)
                                .frame(maxWidth: .infinity)
                            ...
                            // Status / Error
                            if let error = categoryViewModel.aiErrorMessage {
                                HStack {
    ...
    private var canGenerate: Bool {
        !selectedThemes.isEmpty && !categoryViewModel.isGeneratingAI
    }
    ...
    private func generateCategories() {
        Task {
            await categoryViewModel.generateMultipleAICategories(
...
#Preview {
    AICategoryGeneratorView(categoryViewModel: TimesUpCategoryViewModel())
}