    ...
    var body: some View {
        NavigationStack(path: $path) {
            ...
            .navigationDestination(for: SettingsRoute.self) { route in
                switch route {
                case .teams:      TeamsDetailView(gameManager: gameManager)
                case .categories: CategoriesDetailView(gameManager: gameManager)
                case .perks:      PerkSettingsDetailView(gameManager: gameManager)
                }
            }
